...
I've led AI, data, and platform products across PagerDuty, Box, Twilio, Prudential, and Netflix. I also founded ContextSmith, an AI CRM company. The thread through all of it is the same: find the useful product hidden inside a messy system, then make it real.

## What I'm exploring

I'm working on agent infrastructure that is observable and easier to trust, deterministic workflows that still leave room for model judgment, developer platforms for AI-generated software, and product teams where leaders can test ideas by building them.

The broader work lives at [Vibe Coding Dad](https://vibecodingdad.com/). I write about what I'm learning on the [Vibe Coding Dad blog](https://blog.vibecodingdad.com/) and keep the more traditional career history on [LinkedIn](https://www.linkedin.com/in/willcheung/).
